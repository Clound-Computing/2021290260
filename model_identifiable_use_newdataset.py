...
parser.add_argument('-dataset', action="store", type=str, default="data.csv")
parser.add_argument('-kdim', action="store", type=int, default=16)
parser.add_argument('-nhead', action="store", type=int, default=4)
parser.add_argument('-embedim', action="store", type=int, default=256)
...
parser.add_argument('-add_heads', action="store_true", default=True)
